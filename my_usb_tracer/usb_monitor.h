...
private:
	...
	static std::unique_ptr<usb_monitor> instanse_;
	...
	std::function<void(char)> on_device_added_;
	std::function<void(char)> on_device_removed_;
	std::function<bool(char)> on_device_safe_removed_;
	std::function<void(char)> on_device_remove_failed_;
